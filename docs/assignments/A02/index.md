...
I found that the diagonal distances between the members. I then found that my largest force to be 27.778kN. Next to find the cross sectional area of the beam I needed to use known factors of the material, A500 Steel, such as its density, yield strength, safety factor, and max forces. I used these to find the cross section and the estimated weight of the truss.  
